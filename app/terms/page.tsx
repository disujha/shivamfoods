      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-8">
          ...
          <p className="text-gray-600">
            Last updated on 26-11-2025 15:39:35
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-8 space-y-6">
          ...
          <section>
            <p className="text-gray-700 leading-relaxed">
              These Terms and Conditions, along with privacy policy or other terms ("Terms") constitute a binding agreement by and between <strong>SHIVAM FOODS</strong> ("Website Owner" or "we" or "us" or "our") and you ("you" or "your") and relate to your use of our website, goods (as applicable) or services (as applicable) (collectively, "Services").
            </p>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <div className="flex gap-3">
                <span className="font-bold flex-shrink-0" style={{ color: 'var(--secondary-color)' }}>•</span>
                <p>
                  All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Thane, Maharashtra.
                </p>
              </div>
        ...
        <div className="mt-8 flex flex-wrap gap-4 justify-center">
          ...
          <Link
            href="/contact"
            className="px-6 py-3 text-white rounded-lg shadow-md hover:opacity-90 transition-all"
