...
const Header = () => {
    ...
    return (
        <header className="bg-white shadow-md sticky top-0 z-50" style={{ backgroundColor: 'var(--primary-color)' }}>
            {/* Top Bar */}
            <div className="border-b border-white/20">
                <div className="max-w-7xl mx-auto px-4 py-2 flex justify-between items-center text-sm text-white">
            ...
            <div className="max-w-7xl mx-auto px-4 py-3">
                <div className="flex items-center justify-between">
                    ...
                    <Link href="/" className="flex items-center gap-3 hover:opacity-90 transition-opacity">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold" style={{ color: 'var(--secondary-color)' }}>Shivam Foods</h1>
                            <p className="text-xs text-white hidden sm:block">Authentic Gujarati Snacks</p>
                        </div>
                    </Link>
                    ...
                    <div className="flex items-center gap-3">
                        <Link 
                            href="/cart" 
                            className="hidden md:flex items-center gap-2 text-white hover:text-[#ff6b2d] transition-colors"
                        >
            ...
            {/* Mobile Menu */}
            {mobileMenuOpen && (
                <div className="lg:hidden border-t border-white/20 bg-[#0d524b]">
                    <nav className="max-w-7xl mx-auto px-4 py-4 flex flex-col gap-3 text-white">
